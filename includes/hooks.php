	...
	class ABD_Hooks {
		...
		public static function activation() {
			...
			$shortcodeAdditions[] = array( 
				...
				'adblock' => '<a href=""><img src="' . ABD_ROOT_URL . 'images/abd_default-300250.png" alt="You are using an ad blocker! Please consider disabling it to help us out." /></a>'
			);
			...
			$shortcodeAdditions[] = array( 
				...
				'adblock' => '<a href=""><img src="' . ABD_ROOT_URL . 'images/abd_default-336280.png" alt="You are using an ad blocker! Please consider disabling it to help us out." /></a>'
			);
			...
			$shortcodeAdditions[] = array( 
				...
				'adblock' => '<a href=""><img src="' . ABD_ROOT_URL . 'images/abd_default-72890.png" alt="You are using an ad blocker! Please consider disabling it to help us out." /></a>'
			);
			...
			$shortcodeAdditions[] = array( 
				...
				'adblock' => '<a href=""><img src="' . ABD_ROOT_URL . 'images/abd_default-160600.png" alt="You are using an ad blocker! Please consider disabling it to help us out." /></a>'
			);
